      ...
      <div className="space-y-4">
        ...
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-crm-primary/10 rounded-full flex items-center justify-center">
              <svg className="w-6 h-6 text-crm-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
              </svg>
            </div>
            <div>
              <div className="font-semibold text-crm-text-primary text-lg">{cliente.nombre}</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <h4 className="text-sm font-medium text-crm-text-primary">Contacto</h4>
          ...
          <div className="space-y-2">
            <h4 className="text-sm font-medium text-crm-text-primary">Información Comercial</h4>
            <div className="space-y-1">
        ...
        <div className="grid grid-cols-3 gap-4 pt-4 border-t border-crm-border">
          <div className="text-center">
            <div className="text-lg font-semibold text-crm-text-primary">{cliente.propiedades_reservadas}</div>
            <div className="text-xs text-crm-text-muted">Reservadas</div>
          </div>
          <div className="text-center">
            <div className="text-lg font-semibold text-crm-text-primary">{cliente.propiedades_compradas}</div>
            <div className="text-xs text-crm-text-muted">Compradas</div>
          </div>
          <div className="text-center">
            <div className="text-lg font-semibold text-crm-text-primary">{cliente.propiedades_alquiladas}</div>
            <div className="text-xs text-crm-text-muted">Alquiladas</div>
          </div>
        </div>

        {/* Próxima acción */}
        {cliente.proxima_accion && (
          <div className="flex items-center gap-2 p-3 bg-crm-primary/5 rounded-lg">
