...
export default function LoginForm() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        {/* Card principal */}
        <div className="bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-2xl shadow-2xl border border-gray-200 dark:border-slate-700">
          {/* Logo optimizado - Con soporte para modo oscuro/claro */}
          <div className="flex justify-center mb-8">
            <div className="relative">
              {/* Contenedor del logo */}
              <div className="w-32 h-32 sm:w-36 sm:h-36 bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-gray-100 dark:border-slate-700 p-4 flex items-center justify-center transition-all duration-300">
              ...
              <div className="absolute inset-0 bg-blue-500/20 dark:bg-blue-400/20 rounded-2xl blur-xl -z-10"></div>
              <div className="absolute inset-0 bg-blue-500/10 dark:bg-blue-400/10 rounded-2xl blur-2xl -z-20"></div>
            </div>
          </div>

          {/* Título */}
          <div className="text-center mb-8">
            <h1 className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-blue-600 to-blue-400 dark:from-blue-400 dark:to-blue-300 bg-clip-text text-transparent mb-3">
              Bienvenido
            </h1>
          ...
          <div className="mb-6">
            <div className="flex bg-gray-100 dark:bg-slate-800 rounded-xl p-1.5 gap-1">
              <button
                type="button"
          ...
          <form onSubmit={onSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  disabled={pending}
                  className="w-full pl-12 pr-4 py-3.5 border border-gray-300 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  disabled={pending}
                  className="w-full pl-12 pr-12 py-3.5 border border-gray-300 dark:border-slate-600 rounded-xl bg-white dark:bg-slate-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={pending}
              className="w-full bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white py-3.5 px-4 rounded-xl font-semibold shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-slate-900 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-lg transform hover:-translate-y-0.5 active:translate-y-0"
            >
              {pending ? (
                <div className="flex items-center justify-center space-x-2">
