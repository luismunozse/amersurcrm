...
const ClienteRow = memo(function ClienteRow({
  ...
  // Un lead que llegó por alias de WhatsApp no tiene teléfono: sin dígitos el
  // link queda en "https://wa.me/" y abre la landing de WhatsApp, no el chat.
  const waDigits = (cliente.telefono_whatsapp || cliente.telefono || '').replace(/\D/g, '');
