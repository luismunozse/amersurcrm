      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-end sm:items-center justify-center sm:p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full sm:max-w-4xl transform overflow-hidden rounded-t-2xl sm:rounded-2xl bg-white dark:bg-crm-card border-t sm:border-2 border-gray-200 dark:border-crm-border text-left align-middle shadow-2xl transition-all pb-[env(safe-area-inset-bottom)] sm:pb-0">
                {/* Header */}
