      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-end sm:items-center justify-center sm:p-4">
            ...
            >
              <Dialog.Panel className="w-full sm:max-w-2xl transform overflow-hidden rounded-t-2xl sm:rounded-2xl bg-crm-card border-t sm:border border-crm-border shadow-xl transition-all pb-[env(safe-area-inset-bottom)] sm:pb-0">
                {/* Header */}
