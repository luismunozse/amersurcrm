    ...
    <div className="space-y-6">
          ...
          <div key={auto.id} className="bg-crm-card border border-crm-border rounded-xl p-6 hover:shadow-lg transition-shadow duration-200">
            ...
            <div className="flex items-start justify-between mb-4">
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  <Zap className={`w-5 h-5 ${auto.activo ? 'text-purple-600' : 'text-gray-400'}`} />
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div>
                ...
                <p className="text-lg font-semibold text-green-600">{auto.total_completadas}</p>
              </div>
              <div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h4 className="text-sm font-medium text-blue-800 mb-1">¿Qué son las automatizaciones?</h4>
