...
-- VERSIÓN CORREGIDA: Sin dependencia de tabla usuario
...
ADD COLUMN IF NOT EXISTS vendedor_asignado TEXT, -- Cambiado a TEXT en lugar de UUID
...
DROP TRIGGER IF EXISTS trigger_set_codigo_cliente ON crm.cliente;
...
COMMENT ON COLUMN crm.cliente.vendedor_asignado IS 'Vendedor responsable del cliente (texto)';
