# Trustworthy Management Reportes — Delta Spec

Change: `reportes-confiables`. No prior spec covers `admin/reportes` correctness, the vendedor scorecard, or cobranza-report parity with the dashboard mora system. All requirements below are additions.
