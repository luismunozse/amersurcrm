# Interactive Masterplan — Delta Spec

Change: `plano-interactivo`. No prior spec covers the masterplan/plano domain (first formal spec for `crm.proyecto.masterplan` + `crm.lote.data.masterplan_poly`). All requirements below are additions.
